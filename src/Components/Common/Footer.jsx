        ...
        <div className="row pt-5">
          <div className="col-lg-3 col-md-6 mb-5">
            ...
            <div className="d-flex justify-content-start">
              ...
              <Link className="btn btn-outline-primary btn-square mr-2" to="https://www.linkedin.com/in/supriti-gole-3b5445257/">
      ...
      >
        <div className="row">
          ...
          <div className="col-lg-6 text-center text-md-right">
            <p className="m-0 text-white-50">
              Designed by <Link to="https://htmlcodex.com">Meghna Supriti Susmita Shibam</Link>
            </p>
          </div>
        </div>
      </div>
